...
public class BytecodeCompleter implements JavaSymbol.Completer {
   ...
   *
   * @return symbol for requested class, if corresponding class file exists, and {@link io.github.zukkari.sonar.java.resolve.Resolve.JavaSymbolNotFound} otherwise
   */
