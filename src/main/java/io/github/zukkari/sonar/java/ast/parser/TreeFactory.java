...
import io.github.zukkari.sonar.java.ast.api.JavaKeyword;
import io.github.zukkari.sonar.java.ast.api.JavaPunctuator;
import io.github.zukkari.sonar.java.ast.api.JavaRestrictedKeyword;
import io.github.zukkari.sonar.java.ast.api.JavaTokenType;
import io.github.zukkari.sonar.java.model.ArrayDimensionTreeImpl;
import io.github.zukkari.sonar.java.model.InternalSyntaxToken;
import io.github.zukkari.sonar.java.model.JavaTree;
import io.github.zukkari.sonar.java.model.JavaTree.ArrayTypeTreeImpl;
import io.github.zukkari.sonar.java.model.JavaTree.CompilationUnitTreeImpl;
import io.github.zukkari.sonar.java.model.JavaTree.ImportTreeImpl;
import io.github.zukkari.sonar.java.model.JavaTree.PackageDeclarationTreeImpl;
import io.github.zukkari.sonar.java.model.JavaTree.ParameterizedTypeTreeImpl;
import io.github.zukkari.sonar.java.model.JavaTree.PrimitiveTypeTreeImpl;
import io.github.zukkari.sonar.java.model.JavaTree.UnionTypeTreeImpl;
import io.github.zukkari.sonar.java.model.JavaTree.WildcardTreeImpl;
import io.github.zukkari.sonar.java.model.KindMaps;
import io.github.zukkari.sonar.java.model.TypeParameterTreeImpl;
import io.github.zukkari.sonar.java.model.declaration.AnnotationTreeImpl;
import io.github.zukkari.sonar.java.model.declaration.ClassTreeImpl;
import io.github.zukkari.sonar.java.model.declaration.EnumConstantTreeImpl;
import io.github.zukkari.sonar.java.model.declaration.ExportsDirectiveTreeImpl;
import io.github.zukkari.sonar.java.model.declaration.MethodTreeImpl;
import io.github.zukkari.sonar.java.model.declaration.ModifierKeywordTreeImpl;
import io.github.zukkari.sonar.java.model.declaration.ModifiersTreeImpl;
import io.github.zukkari.sonar.java.model.declaration.ModuleDeclarationTreeImpl;
import io.github.zukkari.sonar.java.model.declaration.ModuleNameListTreeImpl;
import io.github.zukkari.sonar.java.model.declaration.OpensDirectiveTreeImpl;
import io.github.zukkari.sonar.java.model.declaration.ProvidesDirectiveTreeImpl;
import io.github.zukkari.sonar.java.model.declaration.RequiresDirectiveTreeImpl;
import io.github.zukkari.sonar.java.model.declaration.UsesDirectiveTreeImpl;
import io.github.zukkari.sonar.java.model.declaration.VariableTreeImpl;
import io.github.zukkari.sonar.java.model.expression.ArrayAccessExpressionTreeImpl;
import io.github.zukkari.sonar.java.model.expression.AssignmentExpressionTreeImpl;
import io.github.zukkari.sonar.java.model.expression.BinaryExpressionTreeImpl;
import io.github.zukkari.sonar.java.model.expression.ConditionalExpressionTreeImpl;
import io.github.zukkari.sonar.java.model.expression.IdentifierTreeImpl;
import io.github.zukkari.sonar.java.model.expression.InstanceOfTreeImpl;
import io.github.zukkari.sonar.java.model.expression.InternalPostfixUnaryExpression;
import io.github.zukkari.sonar.java.model.expression.InternalPrefixUnaryExpression;
import io.github.zukkari.sonar.java.model.expression.LambdaExpressionTreeImpl;
import io.github.zukkari.sonar.java.model.expression.LiteralTreeImpl;
import io.github.zukkari.sonar.java.model.expression.MemberSelectExpressionTreeImpl;
import io.github.zukkari.sonar.java.model.expression.MethodInvocationTreeImpl;
import io.github.zukkari.sonar.java.model.expression.MethodReferenceTreeImpl;
import io.github.zukkari.sonar.java.model.expression.NewArrayTreeImpl;
import io.github.zukkari.sonar.java.model.expression.NewClassTreeImpl;
import io.github.zukkari.sonar.java.model.expression.ParenthesizedTreeImpl;
import io.github.zukkari.sonar.java.model.expression.TypeArgumentListTreeImpl;
import io.github.zukkari.sonar.java.model.expression.TypeCastExpressionTreeImpl;
import io.github.zukkari.sonar.java.model.expression.VarTypeTreeImpl;
import io.github.zukkari.sonar.java.model.statement.AssertStatementTreeImpl;
import io.github.zukkari.sonar.java.model.statement.BlockTreeImpl;
import io.github.zukkari.sonar.java.model.statement.BreakStatementTreeImpl;
import io.github.zukkari.sonar.java.model.statement.CaseGroupTreeImpl;
import io.github.zukkari.sonar.java.model.statement.CaseLabelTreeImpl;
import io.github.zukkari.sonar.java.model.statement.CatchTreeImpl;
import io.github.zukkari.sonar.java.model.statement.ContinueStatementTreeImpl;
import io.github.zukkari.sonar.java.model.statement.DoWhileStatementTreeImpl;
import io.github.zukkari.sonar.java.model.statement.EmptyStatementTreeImpl;
import io.github.zukkari.sonar.java.model.statement.ExpressionStatementTreeImpl;
import io.github.zukkari.sonar.java.model.statement.ForEachStatementImpl;
import io.github.zukkari.sonar.java.model.statement.ForStatementTreeImpl;
import io.github.zukkari.sonar.java.model.statement.IfStatementTreeImpl;
import io.github.zukkari.sonar.java.model.statement.LabeledStatementTreeImpl;
import io.github.zukkari.sonar.java.model.statement.ReturnStatementTreeImpl;
import io.github.zukkari.sonar.java.model.statement.StaticInitializerTreeImpl;
import io.github.zukkari.sonar.java.model.statement.SwitchExpressionTreeImpl;
import io.github.zukkari.sonar.java.model.statement.SwitchStatementTreeImpl;
import io.github.zukkari.sonar.java.model.statement.SynchronizedStatementTreeImpl;
import io.github.zukkari.sonar.java.model.statement.ThrowStatementTreeImpl;
import io.github.zukkari.sonar.java.model.statement.TryStatementTreeImpl;
import io.github.zukkari.sonar.java.model.statement.WhileStatementTreeImpl;
