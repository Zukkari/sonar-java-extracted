...
public class BytecodeVisitor extends ClassVisitor {
   ...
   * which must not be processed by {@link io.github.zukkari.sonar.java.resolve.BytecodeCompleter}, therefore this method always throws {@link IllegalStateException}.
   *
   ...
   * either will be completed by {@link io.github.zukkari.sonar.java.resolve.BytecodeCompleter}, and thus will have this inner class as member (see {@link #defineInnerClass(String, int)}).
   */
