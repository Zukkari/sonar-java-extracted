...
import io.github.zukkari.sonar.java.ast.parser.TypeUnionListTreeImpl;
...
public abstract class JavaTree implements Tree {
   ...
   *
   * Note that {@link io.github.zukkari.sonar.plugins.java.api.tree.InferedTypeTree} and {@link UnionTypeTree} can not have annotations.
   */
